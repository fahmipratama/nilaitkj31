 ...
 <head>
    ...
    <title>Aplikasi Nilai by Fahmi</title>
    <link rel="shortcut icon" href="images/logo rgi.png" type="images/x-icon">
...
<div class="fixed-bottom">
    <div class="card">
        <div class="card-body">
            &copy; 2024-<?=date("Y")?> Web Dev TKJ31
            <span class="float-end">
                versi 1.0 by <a href="http://fahmiofficial.lovestoblog.com/?i=1" target="blank" rel="noopener noreferrer">Fahmi</a>
            </span>
        </div>
    </div>
</div>
